...
// Google Maps API Key
JB.GPX2GM.GM_Api_key = "AIzaSyAyUjHQkB1HTX5vuDY2wpZo99Eq-75RIVI";
// Key für OSM Cycle
...
JB.Icons = function(baseurl) {
	...
	this.square_green		= { icon:   { anchor: {x:8,y:8}, url: baseurl+"Icons/square_green.svg", 
											scaledSize: { width: 15, height: 15, widthUnit: "px", heightUnit: "pMapapix" },
											size: { width: 15, height: 15, widthUnit: "px", heightUnit: "px" } } };
...
JB.GPX2GM.setparameters = function() {  
	...
	JB.GPX2GM.parameters.tcols = (typeof(Tcols)!="undefined") ? Tcols : ["#000000","#ff0000","#00ff00","#0000ff","#eeee00","#ff00ff","#00ffff"]; // Trackfarben in #rrggbb für rot grün blau
